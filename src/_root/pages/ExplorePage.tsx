...
const ExplorePage = () => {
  ...
  const { data: searchedPosts, isFetching: isSearchFetching } = useSearchPostsQuery(debouncedSearch);
  ...
  return (
    <div className="ExplorePage-container">
      <div className="ExplorePage-inner_container">
